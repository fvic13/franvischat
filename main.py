...
def configurar_pagina():
    ...
    st.set_page_config(page_title="Franvi´s chatbot", page_icon= "🧠")

    st.title("Franvi´s chatbot")
...
def area_chat():
    contenedor = st.container(height=altura_contenedor_chat, border=True) #harcodeo si pongo un número fijo en height
    with contenedor:
        mostrar_historial()
